...
export default function Alerts() {
  ...
  const [configStatus, setConfigStatus] = useState({ teams_configured: false, email_configured: false, whatsapp_configured: false });
  ...
  const handleTestWhatsappUser = async () => {
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }}>
          ...
          <div className="card" style={{ border: "1px solid rgba(34,197,94,0.3)" }}>
            ...
            <p style={{ fontSize: "12px", color: "#94a3b8", marginBottom: "16px" }}>
              Deliver instant WhatsApp alerts directly to on-call phone numbers and incident response groups for server CPU/RAM/Disk spikes, downtime, or security alerts.
            </p>

            <form onSubmit={handleSaveConfig}>
              <div style={{ marginBottom: "14px" }}>
                <label style={{ fontSize: "11px", color: "#94a3b8", fontWeight: 700, display: "block", marginBottom: "4px" }}>
                  WHATSAPP USER PHONE NUMBER (DIRECT ALERTS)
                </label>
                <input
                  type="text"
                  className="input-base"
                  placeholder="+919876543210 or +1234567890 (include country code)"
              ...
              <div style={{ marginBottom: "14px" }}>
                <label style={{ fontSize: "11px", color: "#94a3b8", fontWeight: 700, display: "block", marginBottom: "4px" }}>
                  WHATSAPP GROUP ID / NAME (TEAM BROADCASTS)
                </label>
                <input
                  type="text"
                  className="input-base"
                  placeholder="e.g. 120363023456789@g.us or Ops-Alerts"
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px", marginBottom: "14px" }}>
                <div>
                  ...
                  <select
                    ...
                    style={{ background: "#080e1a", color: "#f1f5f9" }}
                  >
                    <option value="callmebot">CallMeBot (Free & Instant)</option>
                    <option value="twilio">Twilio WhatsApp</option>
                    <option value="gateway">Custom Gateway / Webhook</option>
                  </select>
                </div>
                <div>
                  <label style={{ fontSize: "11px", color: "#94a3b8", fontWeight: 700, display: "block", marginBottom: "4px" }}>
                  ...
                  <input
                    type="password"
                    className="input-base"
                    placeholder="CallMeBot apikey or token"
              ...
              <div style={{ background: "rgba(34,197,94,0.06)", border: "1px solid rgba(34,197,94,0.2)", borderRadius: "8px", padding: "10px 12px", marginBottom: "16px", fontSize: "11px", color: "#86efac", lineHeight: "1.5" }}>
                💡 <b>Fast 1-Minute CallMeBot Setup:</b><br />
                1. Send <i>"I allow callmebot to send me messages"</i> to <b>+34 941 87 53 10</b> on WhatsApp.<br />
                2. Enter your phone number and the returned API key above.<br />
                3. Click <b>Test User</b> to verify instant alert delivery!
              </div>

              <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
                <button type="submit" disabled={savingConfig} className="btn-primary" style={{ fontSize: "12px", padding: "8px 16px", background: "#16a34a" }}>
                  {savingConfig ? "Saving..." : "💾 Save WhatsApp"}
                </button>
                <button
                  type="button"
                  onClick={handleTestWhatsappUser}
                  disabled={testingWaUser || !configForm.whatsapp_user_phone}
                  className="btn-secondary"
                  style={{ fontSize: "12px", padding: "8px 12px", background: "rgba(34,197,94,0.15)", color: "#4ade80", border: "1px solid rgba(34,197,94,0.4)" }}
                >
                ...
                <button
                  ...
                  className="btn-secondary"
                  style={{ fontSize: "12px", padding: "8px 12px", background: "rgba(56,189,248,0.15)", color: "#38bdf8", border: "1px solid rgba(56,189,248,0.4)" }}
                >
