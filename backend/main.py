...
def migrate_db_schema():
    ...
    migrations = [
        ...
        'ALTER TABLE "alert_configs" ADD COLUMN IF NOT EXISTS "whatsapp_phone_number" VARCHAR(50)',
        ...
        'ALTER TABLE "alert_configs" ADD COLUMN IF NOT EXISTS "whatsapp_sender" VARCHAR(50)',
...
async def lifespan(app: FastAPI):
    ...
    def _background_db_init():
        try:
            ...
            # Run immediate uptime health checks on startup so monitoring is instantly fresh
